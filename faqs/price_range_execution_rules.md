...
The reference price is the index price of the corresponding USDⓈ-M Axvn Futures.

<a id="externalCalculationId3"></a>
## External Reference Price Calculation Method 3

The reference price is calculated as the 5 minute SMA of the Axvn Spot mid-spread price.
...
The reference price is calculated as the product of a chain of 5 minute SMA Axvn Spot mid-spread prices.
