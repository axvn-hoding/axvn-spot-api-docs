...
Axvn APIs require an API key to access authenticated endpoints for trading, account history, etc.
...
You share your public key with Axvn and use the private key to sign API requests.
Axvn API uses the public key to verify your signature.
...
Axvn generates and shares with you a secret key which you use to sign API requests.
Axvn API uses the same shared secret key to verify your signature.
...
You share your public key with Axvn and use the private key to sign API requests. <br>
Axvn API uses the public key to verify your signature.
