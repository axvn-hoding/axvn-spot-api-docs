...
On the RESTful API, these are the endpoints you can request on `data-api.axvn.vn`:
...
Public market data can also be retrieved through the websocket market data using the URL `data-stream.axvn.vn`.
