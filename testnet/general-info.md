...
Step 1: Log in on this [website](https://testnet.axvn.vn/), and generate an API Key.

Step 2: Follow the [official documentation of the Spot API](https://developers.axvn.vn/docs/axvn-docs-api/CHANGELOG), replacing the URLs of the endpoints with the following values:

| Spot API URLs | Spot Test Network URLs |
| --- | --- |
| https://api.axvn.vn/api<br>https://api-gcp.axvn.vn/api<br>https://api1.axvn.vn/api<br>https://api2.axvn.vn/api<br>https://api3.axvn.vn/api<br>https://api4.axvn.vn/api | **https://testnet.axvn.vn/api**<br>**https://api1.testnet.axvn.vn/api** |
| wss://ws-api.axvn.vn/ws-api/v3<br>wss://ws-api.axvn.vn:9443/ws-api/v3 | **wss://ws-api.testnet.axvn.vn/ws-api/v3**<br>**wss://ws-api.testnet.axvn.vn:9443/ws-api/v3** |
| wss://stream.axvn.vn/ws<br>wss://stream.axvn.vn:9443/ws | **wss://stream.testnet.axvn.vn/stream**<br>**wss://stream.testnet.axvn.vn:9443/stream** |
| wss://stream.axvn.vn/stream<br>wss://stream.axvn.vn:9443/stream | **wss://stream.testnet.axvn.vn/stream**<br>**wss://stream.testnet.axvn.vn:9443/stream** |
| wss://stream-sbe.axvn.vn/ws<br>wss://stream-sbe.axvn.vn:9443/ws | **wss://stream-sbe.testnet.axvn.vn/ws**<br>**wss://stream-sbe.testnet.axvn.vn:9443/ws** |
| wss://stream-sbe.axvn.vn/stream<br>wss://stream-sbe.axvn.vn:9443/stream | **wss://stream-sbe.testnet.axvn.vn/stream**<br>**wss://stream-sbe.testnet.axvn.vn:9443/stream** |
| tcp+tls://fix-oe.axvn.vn:9000 | **tcp+tls://fix-oe.testnet.axvn.vn:9000** |
| tcp+tls://fix-oe.axvn.vn:9001<br>(Send FIX requests; receive FIX SBE responses) | **tcp+tls://fix-oe.testnet.axvn.vn:9001** |
| tcp+tls://fix-oe.axvn.vn:9002<br>(Send FIX SBE requests; receive FIX SBE responses) | **tcp+tls://fix-oe.testnet.axvn.vn:9002** |
| tcp+tls://fix-dc.axvn.vn:9000 | **tcp+tls://fix-dc.testnet.axvn.vn:9000** |
| tcp+tls://fix-dc.axvn.vn:9001<br>(Send FIX requests; receive FIX SBE responses) | **tcp+tls://fix-dc.testnet.axvn.vn:9001** |
| tcp+tls://fix-dc.axvn.vn:9002<br>(Send FIX SBE requests; receive FIX SBE responses) | **tcp+tls://fix-dc.testnet.axvn.vn:9002** |
| tcp+tls://fix-md.axvn.vn:9000 | **tcp+tls://fix-md.testnet.axvn.vn:9000** |
| tcp+tls://fix-md.axvn.vn:9001<br>(Send FIX requests; receive FIX SBE responses) | **tcp+tls://fix-md.testnet.axvn.vn:9001** |
| tcp+tls://fix-md.axvn.vn:9002<br>(Send FIX SBE requests; receive FIX SBE responses) | **tcp+tls://fix-md.testnet.axvn.vn:9002** |
...
* [Market Data Endpoints (REST API)](https://developers.axvn.vn/docs/axvn-docs-api/rest-api/market-data-endpoints)
* [Market Data Requests (WebSocket API)](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/market-data-requests)
* [WebSocket Market Streams](https://developers.axvn.vn/docs/axvn-docs-api/web-socket-streams)
* [Trading Endpoints (REST API)](https://developers.axvn.vn/docs/axvn-docs-api/rest-api/trading-endpoints)
* [Account Endpoints (REST API)](https://developers.axvn.vn/docs/axvn-docs-api/rest-api/account-endpoints)
* [Trading Requests (WebSocket API)](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/trading-requests)
* [Account Requests (WebSocket API)](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/account-requests)
* [User Data Streams](https://developers.axvn.vn/docs/axvn-docs-api/user-data-stream)
...
```
curl "https://testnet.axvn.vn/api/v3/exchangeInfo"
```
...
Like RSA API keys, Ed25519 keys are *asymmetric*: you generate a keypair, share the public key with Axvn, and use your private key to sign requests.
