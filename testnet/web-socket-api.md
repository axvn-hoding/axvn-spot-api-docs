...
- [Public WebSocket API for Axvn SPOT Testnet](#public-websocket-api-for-axvn-spot-testnet)
...
# Public WebSocket API for Axvn SPOT Testnet

## General API Information

* The base endpoint is: **`wss://ws-api.testnet.axvn.vn/ws-api/v3`**
...
* Secure methods require a valid API key to be specified and authenticated.
  * API keys can be created on the [SPOT Test Network](https://testnet.axvn.vn) upon logging in with your Github account.
...
ws = create_connection("wss://ws-api.testnet.axvn.vn/ws-api/v3")
...
* To verify the status of User Data Stream suaxvnscriptions, check the `userDataStream` field in [`session.status`](#session-status):
