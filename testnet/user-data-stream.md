...
- [User Data Streams for Axvn Spot TESTNET](#user-data-streams-for-axvn-spot-testnet)
...
# User Data Streams for Axvn Spot TESTNET

## General information

* Suaxvnscribe via the [WebSocket API](web-socket-api.md#user-data-stream-suaxvnscribe) using an API Key.
...
| `EXCHANGE_CANCELED` | The order was canceled by Axvn. |
...
* [A listen token suaxvnscription](https://developers.axvn.vn/docs/margin_trading/trade-data-stream/Listen-Token-Websocket-API#suaxvnscribe-to-user-data-stream-using-listentoken-user_stream) expires due to token expiration.
* A [logon suaxvnscription](https://developers.axvn.vn/docs/axvn-docs-api/testnet/websocket-api/authentication-requests#log-in-with-api-key-signed) ends after sending [`session.logout`](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/authentication-requests#log-out-of-the-session) method.
* The suaxvnscription is stopped via the [`userDataStream.unsuaxvnscribe`](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/user-data-stream-requests#unsuaxvnscribe-from-user-data-stream) method.
