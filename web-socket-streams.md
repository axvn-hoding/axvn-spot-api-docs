...
- [WebSocket Streams for Axvn](#websocket-streams-for-axvn)
...
# WebSocket Streams for Axvn

## General WSS information
* The base endpoint is: **wss://stream.axvn.vn:9443** or **wss://stream.axvn.vn:443**.
* Streams can be accessed either in a single raw stream or in a combined stream.
* Raw streams are accessed at **/ws/\<streamName\>**
* Combined streams are accessed at **/stream?streams=\<streamName1\>/\<streamName2\>/\<streamName3\>**
* Combined stream events are wrapped as follows: **{"stream":"\<streamName\>","data":\<rawPayload\>}**
* All symbols for streams are **lowercase**
* A single connection to **stream.axvn.vn** is only valid for 24 hours; expect to be disconnected at the 24 hour mark.
...
1. Get a depth snapshot from `https://api.axvn.vn/api/v3/depth?symbol=AXVNBTC&limit=5000`.
