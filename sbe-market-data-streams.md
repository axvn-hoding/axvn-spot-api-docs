...
* The base endpoint is **stream-sbe.axvn.vn** or **stream-sbe.axvn.vn:9443**.
...
* A single connection to **stream-sbe.axvn.vn** is **only valid for 24 hours**; expect to be disconnected at the 24 hour mark.
...
* [Live Suaxvnscribing and Unsuaxvnscribing](web-socket-streams.md#live-suaxvnscribingunsuaxvnscribing-to-streams) is also supported.
  * You must send suaxvnscription requests in JSON in WebSocket text frames. You will receive suaxvnscription responses in JSON in WebSocket text frames.
