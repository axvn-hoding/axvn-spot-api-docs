...
- [User Data Streams for Axvn](#user-data-streams-for-axvn)
...
* A [logon suaxvnscription](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/authentication-requests#log-in-with-api-key-signed) ends after sending [`session.logout`](https://developers.axvn.vn/docs/axvn-docs-api/websocket-api/authentication-requests#log-out-of-the-session) method.
